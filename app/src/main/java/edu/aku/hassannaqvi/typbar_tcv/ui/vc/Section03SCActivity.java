...
public class Section03SCActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        f3.put("tcvcsc11a", bi.tcvcsc11a.isChecked() ? "1" : "0");
        f3.put("tcvcsc11b", bi.tcvcsc11b.isChecked() ? "2" : "0");
        f3.put("tcvcsc11c", bi.tcvcsc11c.isChecked() ? "3" : "0");
        f3.put("tcvcsc11d", bi.tcvcsc11d.isChecked() ? "4" : "0");
        f3.put("tcvcsc11e", bi.tcvcsc11e.isChecked() ? "5" : "0");
        f3.put("tcvcsc11f", bi.tcvcsc11f.isChecked() ? "6" : "0");
        f3.put("tcvcsc11g", bi.tcvcsc11g.isChecked() ? "96" : "0");
        ...
        f3.put("tcvcsc14", bi.tcvcsc14a.isChecked() ? "1" : bi.tcvcsc14b.isChecked() ? "2" : bi.tcvcsc14c.isChecked() ? "3" : bi.tcvcsc14d.isChecked() ? "4" : bi.tcvcsc14e.isChecked() ? "5" : "0");
        f3.put("tcvcsc15", bi.tcvcsc15a.isChecked() ? "1" : bi.tcvcsc15b.isChecked() ? "2" : bi.tcvcsc15c.isChecked() ? "3" : bi.tcvcsc15d.isChecked() ? "4" : bi.tcvcsc15e.isChecked() ? "5" : "0");
