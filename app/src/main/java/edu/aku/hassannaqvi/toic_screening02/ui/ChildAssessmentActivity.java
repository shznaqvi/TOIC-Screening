...
import edu.aku.hassannaqvi.toic_screening02.databinding.ActivitySecChildassessmentBinding;
...
/*
  ...
  //      if (binding.toicb03a.isChecked() /*&& binding.toicb04b.isChecked() && binding.toicb05b.isChecked()
        ...
        return validatorClass.EmptyTextBox(this, binding.toicb09, getString(R.string.toicc01));
    }
