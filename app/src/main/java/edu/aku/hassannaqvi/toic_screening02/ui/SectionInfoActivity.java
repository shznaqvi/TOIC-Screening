...
import edu.aku.hassannaqvi.toic_screening02.databinding.ActivitySectionInfoBinding;
    ...
    private boolean UpdateDB() {
        ...
        if (updcount != 0) {
            ...
            if (!toica01.isChecked()) {
                if (db.updateSerialWRTDate(new SimpleDateFormat("dd-MM-yy").format(new Date()), binding.toica02.getText().toString()) != 0) {
